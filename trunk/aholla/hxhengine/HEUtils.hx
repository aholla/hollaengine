...
class HEUtils 
{
	...
	*/
	...
	public static var PI				:Float = 3.1415926535897932384626433832795;
	public static var TO_RADIANS		:Float = 0.01745329251994329576923690768489;
	public static var TO_DEGREES		:Float = 57.295779513082320876798154814105;
	
	public function new() 
	{			
	}
	
	public static function getAngle(pointA:Point, pointB:Point):Float 
	{
